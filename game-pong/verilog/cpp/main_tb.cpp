...
class	TESTBENCH : public TESTB<Vtop> {
private:
...
public:
	...
	TESTBENCH(void) : m_test(false), m_vga(800, 600) {
		init();
	}
 ...
 */
        ...
        m_vga (
              (m_core->PIN_13)?1:0,
              (m_core->PIN_12)?1:0,
              (m_core->PIN_11)?0xFF:0x00,
              (m_core->PIN_10)?0xFF:0x00,
              (m_core->PIN_9)?0xFF:0x00
              );
