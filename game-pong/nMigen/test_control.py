...
# // Module Name: test_control.py
# //
# // Description: Test control players.
# //
# // Dependencies: 
# //
# // Revisions: 
...
class test_control (Elaboratable):
    ...
    def elaborate(self, platform: Platform) -> Module:
        ...
        mod_4 = player (mod_3.strRGB_o, ctl_1.pos_ply1, offset= screen.offset_count)
        mod_5 = player (mod_4.strRGB_o, ctl_1.pos_ply2, offset= screen.width-screen.offset_count)

        # Create a scoreboard for player's goals.
        mod_6 = scoreboard (mod_5.strRGB_o, 0, counter[15], counter[16])

        # Add all submodules.
        m.submodules += [mod_0, mod_1, mod_2, mod_3, mod_4, mod_5, mod_6, din_1, ctl_1]
