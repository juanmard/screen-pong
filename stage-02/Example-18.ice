{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "93b6af5a-5a2d-48ff-bf3e-9e3fc7457d89",
          "type": "basic.constant",
          "data": {
            "name": "N",
            "value": "18",
        ...
        {
          "id": "c28a6aae-6cda-448c-9b31-45b06d7daf6c",
          "type": "basic.constant",
          "data": {
            "name": "reset",
            "value": "480",
        ...
        {
          "id": "332e3411-024d-4c94-b731-eeb666f8c86d",
          "type": "basic.constant",
          "data": {
            "name": "color",
            "value": "3'b101",
        ...
        {
          "id": "9dfb18a4-96ab-4766-a940-b64c6f885a39",
          "type": "basic.constant",
          "data": {
            "name": "color",
            "value": "3'b110",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<H1>Ejemplo 18 - Probar los controles con PxsBigDigit.\nHay que crear un nuevo bloque Pxs que muestre en pantalla el número de 10 bits pasado como parámetro.\nSe usará para comprobar las posiciones entregadas por los controles.\n</H1>",
            "readonly": true
          },
          "position": {
            "x": -248,
        ...
        {
          "id": "5860a907-7406-4bd3-b6cd-b1e44dcf8cff",
        ...
        {
          "id": "e81b9492-9ebe-4f1f-911d-f02fd7b8427b",
        ...
        {
          "id": "aa426b4a-9f82-45bc-84e3-afeae2959e94",
        ...
        {
          "id": "72422138-4804-402f-8501-3ff73e7bbd70",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "e14a88b7-5f44-421e-9872-8d3acc8915e2",
          "type": "5d5945e13623e3dea020e8b84166bb69254655dd",
          "position": {
            "x": 704,
            "y": -24
          },
        ...
        {
          "id": "ccf71250-b913-45e3-9feb-4561b4ba6241",
          "type": "5d5945e13623e3dea020e8b84166bb69254655dd",
          "position": {
            "x": 1016,
            "y": 8
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "93b6af5a-5a2d-48ff-bf3e-9e3fc7457d89",
            "port": "constant-out"
          },
          "target": {
            "block": "e81b9492-9ebe-4f1f-911d-f02fd7b8427b",
        ...
        {
          "source": {
            "block": "c28a6aae-6cda-448c-9b31-45b06d7daf6c",
            "port": "constant-out"
          },
          "target": {
            "block": "72422138-4804-402f-8501-3ff73e7bbd70",
            "port": "reset"
          },
          "vertices": []
        },
        ...
        {
          "source": {
            "block": "aa426b4a-9f82-45bc-84e3-afeae2959e94",
            "port": "10563024-bd0a-4a4d-856c-4bb1dff3f104"
          },
          "target": {
            "block": "e14a88b7-5f44-421e-9872-8d3acc8915e2",
        ...
        {
          "source": {
            "block": "5860a907-7406-4bd3-b6cd-b1e44dcf8cff",
        ...
        },
        {
          ...
          "target": {
            "block": "e14a88b7-5f44-421e-9872-8d3acc8915e2",
            "port": "2c5906c0-9ca3-4945-96e6-4288517111b6"
          },
          "vertices": [
            {
              "x": 632,
        ...
        {
          "source": {
            "block": "332e3411-024d-4c94-b731-eeb666f8c86d",
            "port": "constant-out"
          },
          "target": {
            "block": "e14a88b7-5f44-421e-9872-8d3acc8915e2",
        ...
        {
          "source": {
            "block": "9dfb18a4-96ab-4766-a940-b64c6f885a39",
            "port": "constant-out"
          },
          "target": {
            "block": "ccf71250-b913-45e3-9feb-4561b4ba6241",
            "port": "7bdb3111-a64b-418e-b237-42123caca291"
          },
          "vertices": []
        },
  ...
  "dependencies": {
    ...
    "5d5945e13623e3dea020e8b84166bb69254655dd": {
      "package": {
        "name": "PxsNumber",
        "version": "1.0",
