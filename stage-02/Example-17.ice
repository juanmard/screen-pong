{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "697285fe-c5af-414c-8a9c-4a112c85f22e",
          "type": "basic.constant",
          "data": {
            "name": "N",
            "value": "25",
        ...
        {
          "id": "7fe98b1a-434f-46c6-9ff4-1eb4b681e42e",
          "type": "basic.constant",
          "data": {
            "name": "color",
            "value": "3'b011",
        ...
        {
          "id": "0151df43-aae5-4c8a-b663-fa720b46ecc2",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<b>Ejemplo 15 - Probar el número con dinámica y visualización por separado.</b>\n<p>En este ejemplo empezaremos a probar los bloques de tipo <i>\"Overlay\"</i>. Estos bloques se usan en conjunción\ncon bloques <i>\"Videogen\"</i> y superponen a este último una imagen, a modo de capas. Se pueden superponer las\ncapas que queramos, sabiendo que no hay transparencia de pixel y que la última capa será la que prevalezca sobre\nlas demás.</br>\nEn este ejemplo superpondremos un único bloque del dígito del marcador <i>(<b>PxsNumbers</b>)</i> probándolo al\nmismo tiempo. Para situar el número emplearemos una asignación directa desde un bloque de código y para\nincrementar el valor del número se usará un preescalado de la colección estándar.</p>",
            "readonly": true
          },
          "position": {
            "x": -96,
        ...
        {
          "id": "12ab12d6-8c40-4e42-aa8e-8de92f6ff125",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "579fe5a3-8ceb-48c5-bb2b-e8b0b57fe3cb",
          "type": "d5e6bc7725b81c38deed641c93e5115c69070d39",
          "position": {
            "x": 904,
            "y": 104
          },
        ...
        {
          "id": "ece45949-1952-449d-a208-07a0578e0c0e",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "0151df43-aae5-4c8a-b663-fa720b46ecc2",
        ...
        },
        {
          ...
          "target": {
            "block": "579fe5a3-8ceb-48c5-bb2b-e8b0b57fe3cb",
        ...
        {
          "source": {
            "block": "12ab12d6-8c40-4e42-aa8e-8de92f6ff125",
            "port": "number"
          },
          "target": {
            "block": "579fe5a3-8ceb-48c5-bb2b-e8b0b57fe3cb",
        ...
        {
          "source": {
            "block": "7fe98b1a-434f-46c6-9ff4-1eb4b681e42e",
            "port": "constant-out"
          },
          "target": {
            "block": "579fe5a3-8ceb-48c5-bb2b-e8b0b57fe3cb",
        ...
        {
          "source": {
            "block": "ece45949-1952-449d-a208-07a0578e0c0e",
        ...
        {
          "source": {
            "block": "697285fe-c5af-414c-8a9c-4a112c85f22e",
            "port": "constant-out"
          },
          "target": {
            "block": "ece45949-1952-449d-a208-07a0578e0c0e",
  ...
  "dependencies": {
    ...
    "d5e6bc7725b81c38deed641c93e5115c69070d39": {
      "package": {
        "name": "PxsNumber",
        "version": "1.0",
        "description": "Overlay a number from 0 to 9 in a stream RGB.",
        "author": "Juan Manuel Rico",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22652.495%22%20height=%22576.305%22%20viewBox=%220%200%20611.71429%20540.28571%22%3E%3Cg%20transform=%22translate(-69.857%20-230.79)%22%20stroke=%22#fff%22%3E%3Crect%20width=%22605.714%22%20height=%22534.286%22%20x=%2271.429%22%20y=%2272.362%22%20ry=%2278.704%22%20transform=%22translate(3.28%20163.28)%22%20stroke-width=%226%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22/%3E%3Cpath%20d=%22M-279.63%2047.693V93.99%22%20transform=%22matrix(1.94017%200%200%202.03922%20737.956%20251.598)%22%20fill=%22none%22%20stroke-width=%2215%22/%3E%3Cpath%20d=%22M164.815%20112.508h53.704%22%20transform=%22matrix(1.94017%200%200%202.03922%20-138.714%20217.61)%22%20fill=%22none%22%20stroke-width=%2215%22/%3E%3Cpath%20d=%22M211.111%2064.36v92.592%22%20transform=%22matrix(1.94017%200%200%202.03922%20-117.156%20221.387)%22%20fill=%22none%22%20stroke-width=%2215%22/%3E%3C/g%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
