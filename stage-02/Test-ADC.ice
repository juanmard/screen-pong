{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "eb3fa053-533f-47f0-83b3-d60db119e7ca",
          "type": "basic.output",
          "data": {
            "name": "out_ply1",
            "pins": [
        ...
        {
          "id": "14753499-8670-4c27-ba25-3791da485646",
          "type": "basic.output",
          "data": {
            "name": "out_ply2",
            "pins": [
        ...
        {
          "id": "fe790d25-dd50-4f0b-ad50-dec4b0f2f643",
          "type": "basic.constant",
          "data": {
            "name": "N",
            "value": "19",
        ...
        {
          "id": "f21f7fb4-5ab2-4f55-93e4-bc6540154177",
        ...
        {
          "id": "2629044c-5a1d-493a-b863-f6401d3bff86",
        ...
        {
          "id": "4a93078d-a6bd-46ad-a049-c4835ec15d36",
          "type": "789d2ee2b16d2509424c327e26d4f6a72ee0a600",
          "position": {
            "x": 504,
            "y": 360
          },
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "4a93078d-a6bd-46ad-a049-c4835ec15d36",
            "port": "c3e8f8fa-d600-4009-954d-8b6afe5a6027"
          },
          "target": {
            "block": "eb3fa053-533f-47f0-83b3-d60db119e7ca",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "4a93078d-a6bd-46ad-a049-c4835ec15d36",
            "port": "8e575c9a-672a-464e-adb2-5121b99ca1ba"
          },
          "target": {
            "block": "14753499-8670-4c27-ba25-3791da485646",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "fe790d25-dd50-4f0b-ad50-dec4b0f2f643",
            "port": "constant-out"
          },
          "target": {
            "block": "4a93078d-a6bd-46ad-a049-c4835ec15d36",
            "port": "2420468d-3692-46b6-9083-99d09cc0c576"
          }
        },
        {
          "source": {
        ...
        {
          "source": {
            "block": "f21f7fb4-5ab2-4f55-93e4-bc6540154177",
        ...
        },
        {
          ...
          "target": {
            "block": "2629044c-5a1d-493a-b863-f6401d3bff86",
  ...
  "dependencies": {
    ...
    "789d2ee2b16d2509424c327e26d4f6a72ee0a600": {
      "package": {
        "name": "Control-Pong-ADC",
        "version": "1.0",
        "description": "Analog control for Pong game.",
        "author": "Juan Manuel Rico",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "d7f35b46-ba03-4aad-bb5c-371a5fb385b8",
              "type": "basic.input",
              "data": {
                "name": "clk",
                "clock": false
            ...
            {
              "id": "c3e8f8fa-d600-4009-954d-8b6afe5a6027",
              "type": "basic.output",
              "data": {
                "name": "out_ply1"
              },
            ...
            {
              "id": "8e575c9a-672a-464e-adb2-5121b99ca1ba",
              "type": "basic.output",
              "data": {
                "name": "out_ply2"
              },
            ...
            {
              "id": "2420468d-3692-46b6-9083-99d09cc0c576",
              "type": "basic.constant",
              "data": {
                "name": "Pulse",
                "value": "22",
            ...
            },
            {
              ...
              "type": "basic.info",
              "data": {
                "info": "<H3>Control game by simple ADC with RC.</H3>\n<p>A new control game by analog control.</br>\nJuan Manuel Rico - v1.0</p>",
                "readonly": true
              },
              "position": {
                "x": -16,
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "c3e8f8fa-d600-4009-954d-8b6afe5a6027",
                "port": "in"
              }
            },
            {
              ...
              "target": {
                "block": "8e575c9a-672a-464e-adb2-5121b99ca1ba",
                "port": "in"
              }
            },
            {
              "source": {
                "block": "2420468d-3692-46b6-9083-99d09cc0c576",
                "port": "constant-out"
              },
              "target": {
                "block": "4c2e61df-faeb-4294-b88e-a264e05112e3",
            ...
            {
              "source": {
                "block": "d7f35b46-ba03-4aad-bb5c-371a5fb385b8",
                "port": "out"
              },
              "target": {
                "block": "4c2e61df-faeb-4294-b88e-a264e05112e3",
